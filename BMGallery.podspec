...
Pod::Spec.new do |s|
  s.name             = 'BMGallery'
  s.version          = '0.1.0'
  s.summary          = 'A short description of BMGallery.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/LEE ZHE YU/BMGallery'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'LEE ZHE YU' => 'tzef8220@gmail.com' }
  s.source           = { :git => 'https://github.com/LEE ZHE YU/BMGallery.git', :tag => s.version.to_s }
